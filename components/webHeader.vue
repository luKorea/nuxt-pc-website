      ...
      <div class="nav-wrap">
        ...
        <el-menu :default-active="activeIndex"
          ...
          <el-submenu index="2">
            ...
            <el-menu-item index="2-1">千职鹤APP</el-menu-item>
            <el-menu-item index="2-2">校园生涯平台</el-menu-item>
            <el-menu-item index="2-3">生涯咨询规划</el-menu-item>
          </el-submenu>
          <el-menu-item index="/webArticle">生涯咨询</el-menu-item>
          <el-submenu index="3">
            <template slot="title">关于我们</template>
            <el-menu-item index="2-1">企业简介</el-menu-item>
            <el-menu-item index="2-2">企业动态</el-menu-item>
...
export default {
  ...
  data () {
    return {
      activeIndex: '/',
      defaultLogo: require('~/static/image/logo.png'),
      link: [
        {
          id: nanoid(),
          href: '/',
